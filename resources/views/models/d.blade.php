...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="headline text-center no-maigin-bottom">
                ...
                <h2><b>D</b> <span class="font-weight-light te font">3AГBAP</span></h2>
            </div>
        </div>
    </div>
    <!--        div haasan-->
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <img src="{{asset('front/assets/images/designs/54.12.png')}}" width="100%" style="border-radius: 10px">
            <!--            desription row-->
            {{--<div class="row">--}}
                {{--<div class="col-md-11">--}}
                    {{--<br>--}}
