...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="headline text-center no-maigin-bottom">
                ...
                <h2><b>J</b> <span class="font-weight-light te font">3AГBAP</span></h2>
            </div>
        </div>
    </div>
    <!--        div haasan-->
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <img src="{{asset('front/assets/images/designs/67.24.png')}}" width="100%" style="border-radius: 10px">
            <!--            desription row-->
            {{--<div class="row">--}}
                {{--<div class="col-md-11">--}}
                    {{--<br>--}}
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="image-box wow fadeInUp">
                    ...
                    <div class="image-box-thumbnail">
                        <a href="{{url("/models/1")}}"><img src="{{asset('front/assets/images/54.95.jpg')}}" alt=""></a>
                    </div><!-- image-box-thumbnail -->
            ...
            <div class="col-md-4">
                <div class="image-box wow fadeInUp">
                    ...
                    <div class="image-box-thumbnail">
                        <a href="{{url("/models/2")}}"><img src="{{asset('front/assets/images/67.24.jpg')}}" alt=""></a>
                    </div><!-- image-box-thumbnail -->
